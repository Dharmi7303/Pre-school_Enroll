...
<head>
  ...
  <title>School Enrollment System  | Add Teacher</title>
...
<!--  Full Name--->
   <div class="form-group">
                    ...
                    <center><input type="text" class="form-control" id="fullname" name="fullname" placeholder="Enter Teacher Full Name" required></center>
                  </div>
<!--   Email---->
                  <div class="form-group">
