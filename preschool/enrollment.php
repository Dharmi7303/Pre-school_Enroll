...
<option value="10-11 Year">10-11 Year</option>
</select>
...
<select class="form-control" id="erollprogram" name="erollprogram"  required>
                        ...
                        <option value="First Standard 6 to 7 years">First Standard 6 to 7 years</option>
                        <option value="Second Standard 7 to 8 years">Second Standard 7 to 8 years</option>
                        <option value="Third Standard 8 to 9 years">Third Standard 8 to 9 years</option>
                        <option value="Fourth Standard 9 to 10 years">Fourth Standard 9 to 10 years</option>
                        <option value="Fifth Standard 10 to 11 years">Fifth Standard 10 to 11 years</option>
